                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="mr-2 d-none d-lg-inline text-gray-600 small"><?php echo "$nombre $apellido"; ?>!</h1></span>
...
$sql = "SELECT id, nombre, apellido, correo_electronico, contrasena FROM usuarios";
...
if ($result->num_rows > 0) {
    ...
    echo '<h6 class="m-0 font-weight-bold text-primary">Usuarios</h6>';
    echo '</div>';
    ...
    // Mostrar datos de cada usuario en la tabla
    while($row = $result->fetch_assoc()) {
        ...
        echo '<td>';
        echo '<button class="btn btn-primary btn-sm">Editar</button>';
